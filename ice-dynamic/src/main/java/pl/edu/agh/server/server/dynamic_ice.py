...
if 'A' not in _M_Demo.__dict__:
    ...
    class A(object):
        def __init__(self, a=0.0, b=0.0, c=0.0, d=''):
            self.a = a
            self.b = b
            self.c = c
            self.d = d
...
if '_t_numberList' not in _M_Demo.__dict__:
    _M_Demo._t_numberList = IcePy.defineSequence('::Demo::numberList', (), _M_Demo._t_A)
...
if 'EmptyList' not in _M_Demo.__dict__:
    _M_Demo.EmptyList = Ice.createTempClass()
    class EmptyList(Ice.UserException):
        def __init__(self):
            pass
        ...
        _ice_id = '::Demo::EmptyList'

    _M_Demo._t_EmptyList = IcePy.defineException('::Demo::EmptyList', EmptyList, (), False, None, ())
    EmptyList._ice_type = _M_Demo._t_EmptyList

    _M_Demo.EmptyList = EmptyList
    del EmptyList
...
if 'CalcPrx' not in _M_Demo.__dict__:
    ...
    class CalcPrx(Ice.ObjectPrx):
        ...
        def avg(self, List, context=None):
            return _M_Demo.Calc._op_avg.invoke(self, ((List, ), context))

        def avgAsync(self, List, context=None):
            return _M_Demo.Calc._op_avg.invokeAsync(self, ((List, ), context))

        def begin_avg(self, List, _response=None, _ex=None, _sent=None, context=None):
            return _M_Demo.Calc._op_avg.begin(self, ((List, ), _response, _ex, _sent, context))
    ...
    class Calc(Ice.Object):
        ...
        def avg(self, List, current=None):
    ...
    Calc._op_avg = IcePy.Operation('avg', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), _M_Demo._t_numberList, False, 0),), (), ((), IcePy._t_string, False, 0), (_M_Demo._t_EmptyList,))
